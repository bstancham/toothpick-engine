...
public class ProgMaintainDronesNum implements ProgramBehaviour, TPEncodingHelper {
    ...
    @Override
    public ProgMaintainDronesNum copy() {
        ProgMaintainDronesNum out = new ProgMaintainDronesNum();
        out.goalNum = goalNum;
